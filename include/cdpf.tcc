...
template <typename T> T &operator>>(T &is, CDPF &cdpf) {
...
template <typename T> T &operator<<(T &os, const CDPF &cdpf) {
...
template <typename T>
RegBS CDPF::is_zero(MPCTIO &tio, yield_t &yield, const T &x, size_t &aes_ops) {

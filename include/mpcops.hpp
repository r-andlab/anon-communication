...
void mpc_select(MPCTIO &tio, yield_t &yield, RegAS &z, RegBS f, RegAS x,
                RegAS y, nbits_t nbits = VALUE_BITS);
...
void mpc_select(MPCTIO &tio, yield_t &yield, RegXS &z, RegBS f, RegXS x,
                RegXS y, nbits_t nbits = VALUE_BITS);
...
value_t mpc_reconstruct(MPCTIO &tio, yield_t &yield, RegXS f,
                        nbits_t nbits = VALUE_BITS);
...
//
// Cost: 1 word sent in 1 message
value_t mpc_reconstruct(MPCTIO &tio, yield_t &yield, RegAS x,
                        nbits_t nbits = VALUE_BITS);

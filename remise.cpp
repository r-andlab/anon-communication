...
void RemiseSAM::post_message(MPCTIO &tio, yield_t & yield, RegAS ind, RegAS val, RegAS proof) {
...
RegAS RemiseSAM::read_message(MPCTIO &tio, yield_t & yield, RegAS ind, RegAS proof_submitted) {
 ...
 void RemiseSAM::provide_or_remove_access(MPCTIO &tio, yield_t & yield, RegAS ind, RegAS proof_submitted) {
...
void RemiseSAM::initialize_proofDB(MPCTIO &tio, yield_t & yield, size_t dbsize, Writer writer) {
...
void RemiseSAM::publish_bulletin_board(MPCTIO &tio, yield_t & yield, size_t dbsize) {

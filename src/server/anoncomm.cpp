...
void SAM::post_message(MPCTIO &tio, yield_t &yield, RegAS ind, RegAS val,
                       RegAS proof) {
...
RegAS SAM::read_message(MPCTIO &tio, yield_t &yield, RegAS ind,
...
void SAM::provide_or_remove_access(MPCTIO &tio, yield_t &yield, RegAS ind,
                                   RegAS proof_submitted) {
...
void SAM::initialize_proofDB(MPCTIO &tio, yield_t &yield, size_t dbsize,
                             Writer writer) {
